...
def fast_adapt(sup_img,
    ...
    logits_qry = head(qry_emb, sup_emb, lin_sup_msk, 2, sup_emb.size(1) // 2, 
                      lambda_reg=10.0 if 'resnet50' in network_name or 'resnet18' in network_name else 1.0)
...
def main(n_shots=5,             # Number of shots of each task.
    ...
    exp_group_name = 'metaoptnet_ridge_%s_%s_%s_%s' % (network_name, loss_name, trg_dataset, trg_task)
