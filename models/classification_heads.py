...
#     b_inv, _ = torch.gesv(id_matrix, b_mat) # Oldest Pytorch.
#     b_inv, _ = torch.solve(id_matrix, b_mat) # Old pytorch.
...
def MetaOptNetHead_Ridge(query, support, support_labels, n_way, n_shot, lambda_reg=1.0, double_precision=False):
    """
...
def R2D2Head(query, support, support_labels, n_way, n_shot, l2_regularizer_lambda=1.0):
    """
    Fits the support set with ridge regression and 
    returns the classification score on the query set.
...
def MetaOptNetHead_SVM_He(query, support, support_labels, n_way, n_shot, C_reg=0.0001, double_precision=False):
    """
...
def MetaOptNetHead_SVM_CS(query, support, support_labels, n_way, n_shot, C_reg=0.0001, double_precision=False, maxIter=5): #50):
# ORIGINAL: def MetaOptNetHead_SVM_CS(query, support, support_labels, n_way, n_shot, C_reg=0.1, double_precision=False, maxIter=15):
    """
    Fits the support set with multi-class SVM and 
    returns the classification score on the query set.
...
def MetaOptNetHead_SVM_WW(query, support, support_labels, n_way, n_shot, C_reg=0.0001, double_precision=False):
    """
    Fits the support set with multi-class SVM and 
    returns the classification score on the query set.
